...
export default function TodoList({ todos }: ITodoListProps) {
  return (
    <div className="w-[95%] sm:w-full mx-auto overflow-x-auto shadow-xl rounded-lg">
      <table className="min-w-full bg-white border-separate border-spacing-0 border border-gray-300 rounded-lg">
        <thead>
          <tr className="bg-[#a6a9b4] text-white">
            ...
            <th className="p-3 sm:p-5 text-left text-base sm:text-lg font-semibold">Actions</th>
          </tr>
        </thead>
        <tbody>
          {todos.length > 0 ? (
            ...
            <tr>
              <td colSpan={3} className="p-3 sm:p-5 text-center text-sm sm:text-base text-gray-600">
